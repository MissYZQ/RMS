...
public class UserManagementController {
	...
	@RequestMapping("checkUserByEmail/{eMail}")
	@ResponseBody
	public ResultUtil checkUserEmail(@PathVariable("eMail")String eMail, Long uid){
	...
	@RequestMapping("checkUserByNickname")
	@ResponseBody
	public ResultUtil checkNickname(String nickname, Long uid){
